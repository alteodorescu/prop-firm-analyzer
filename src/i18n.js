...
const translations = {
  ...
  filterAllAccounts: { en: "All accounts", ro: "Toate conturile" },
  filterChallengeActive: { en: "Challenge — Active", ro: "Evaluare — Activ" },
  filterChallengeTargetHit: { en: "Challenge — Target hit", ro: "Evaluare — Obiectiv atins" },
  filterFundedActive: { en: "Funded — Active", ro: "Finanțat — Activ" },
  filterFundedTargetHit: { en: "Funded — Payout ready", ro: "Finanțat — Gata de plată" },
  filterTypeLabel: { en: "Type", ro: "Tip" },
  filterStatusLabel: { en: "Status", ro: "Status" },
  all: { en: "All", ro: "Toate" },
  active: { en: "Active", ro: "Activ" },
  archiveSelected: { en: "Archive selected", ro: "Arhivează selectate" },
  alertArchiveSelected: { en: "Archive {0} account(s)? They stay in the Dashboard for history.", ro: "Arhivezi {0} cont(uri)? Rămân în Dashboard pentru istoric." },
  ...
  autoTradovateUsername: { en: "Tradovate Username", ro: "Utilizator Tradovate" },
  autoTradovateUsernamePlaceholder: { en: "Your Tradovate username", ro: "Utilizatorul tău Tradovate" },
  autoTradovatePassword: { en: "Tradovate Password", ro: "Parolă Tradovate" },
  autoTradovatePasswordPlaceholder: { en: "Your Tradovate password", ro: "Parola ta Tradovate" },
  ...
  autoTradovateCredNote: { en: "Credentials are encrypted and used only for automated trading", ro: "Credențialele sunt criptate și folosite doar pentru tranzacționare automatizată" },
